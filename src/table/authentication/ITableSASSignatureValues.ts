...
function generateTableSASSignature20181109(
  ...
  const stringToSign = [
    ...
    version,
    tableSASSignatureValues.signedResource,
    tableSASSignatureValues.snapshot,
    tableSASSignatureValues.cacheControl
      ? tableSASSignatureValues.cacheControl
      : "",
    tableSASSignatureValues.contentDisposition
      ? tableSASSignatureValues.contentDisposition
      : "",
    tableSASSignatureValues.contentEncoding
      ? tableSASSignatureValues.contentEncoding
      : "",
    tableSASSignatureValues.contentLanguage
      ? tableSASSignatureValues.contentLanguage
      : "",
    tableSASSignatureValues.contentType
      ? tableSASSignatureValues.contentType
      : ""
  ].join("\n");
